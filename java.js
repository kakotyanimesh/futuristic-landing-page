...
const selections = document.querySelectorAll('.menu-selection');
const offset =100;

//loop through selections
for(let i =0; i< selections.lenght; i++) {
    //Set scroll event on window 
    window.addEventListener('scroll', () =>{
        /*Activate pagination when the 
        corresponding section is scrolled over*/
...
$(".brand_carousel").owlCarousel({
  ...
  var FlipDown = function () {
    function FlipDown(uts) {
      ...
      console.log("FlipDown ".concat( " (Theme: ").concat(this.opts.theme, ")"));
    }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    var twoDaysFromNow = (new Date("Feb 26, 2023 00:00:00").getTime() / 1000);
